...
To build the final jar and optimize the RabbitHomeManagerApplication application for production, run:
...
Then navigate to [http://localhost:25110](http://localhost:25110) in your browser.
